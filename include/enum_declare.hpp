...
struct CRUST_EBCO EnumTagUnion :
    ...
    constexpr bool is_variant() const {
        return index == __IndexGetter<typename RemoveRef<T>::Result>::result;
    }
...
struct CRUST_EBCO EnumTagOnly :
    ...
    template<class T>
    constexpr bool eq_variant() const { return is_variant(); }
...
class CRUST_EBCO Enum :
        public Impl<cmp::PartialEq<Enum<Fields...>>, Derive<Fields, cmp::PartialEq>::result...>,
...
template<class T, class ...Fields>
CRUST_CXX14_CONSTEXPR __impl_enum::LetEnum<T, Fields...> let(Fields &...fields) {
